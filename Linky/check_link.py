# Original version taken from https://gist.github.com/hackerdem/2872d7f994d192188970408980267e6e

from bs4 import BeautifulSoup, SoupStrainer
from pip._vendor import colorama  # for pulling out data out of html/xml
    ...
    def check(self, address):
        try:
            ...
            if resp.status in [400, 404, 403, 408, 409, 501, 502, 503]:
                print(Fore.RED + resp.status + "-" + resp.reason + "-->" +
                      address)
            else:
    ...
    for key, value in iter(tags.items()):
        try:
            ...
            for link in BeautifulSoup(
                    response, "html.parser", parse_only=SoupStrainer(key)):
